...
<div className='relative mt-6'>
    ...
    <div className='absolute font-normal font-sans text-slate-400 w-full lg:w-[550px] my-3 items-center flex justify-center lg:justify-between top-0 lg:gap-0 gap-32 lg:left-14'>
