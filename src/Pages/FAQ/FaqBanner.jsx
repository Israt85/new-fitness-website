...
const FaqBanner = () => {
    return (
        <div className='w-full -mt-20 h-[500px] bg-black'>
            <div className='flex items-center pt-20'>
                <div>
                    <img src={imgleft} alt="" />
                </div>
                <div className='w-[700px] font-teko font-bold text-white text-center'>
<p className='text-7xl'>How can we help?</p>
<div className='relative mt-6'>
    <input className='w-[580px] py-3 rounded-2xl' type="text" />
    <div className='absolute font-normal font-sans text-slate-400 w-[550px] my-3 items-center flex justify-between top-0 left-14'>
