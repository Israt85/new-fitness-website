...
const GeneralFaq = () => {
    return (
        <div className='w-full mb-10 bg-black h-[700px]'>
            <h2 className='text-7xl font-teko font-bold text-white pt-10 px-14'>General FAQs</h2>
           <div className='flex justify-center gap-10 items-center'>
           <div className='w-[700px] mt-6 text-white h-[500px]'>
