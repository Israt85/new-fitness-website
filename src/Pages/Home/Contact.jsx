        ...
        <div className='w-full mt-10 bg-black h-auto'>
            <div className=' flex lg:flex-row flex-col justify-around'>
                <div className='w-full lg:w-[800px]'>
                    ...
                    <p className='w-full lg:w-[680px] text-3xl lg:text-7xl font-bold px-11 text-white font-teko'>Send Us A Message
                    & Join Our Team!</p>
                    <div className='flex lg:flex-row flex-col my-6 justify-center gap-16'>
